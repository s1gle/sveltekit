...
<table style="display: relative; width: 80%; text-align: center; font-weight: 500">
    <tbody>
    <tr>
        <td style='background-color: DarkRed; color: white'>DarkRed</td>
        <td style='background-color: Pink; color: black'>Pink</td>
        <td style='background-color: LightPink; color: black'>LightPink</td>
        <td style='background-color: HotPink'>HotPink</td>
    </tr>
    <tr>
        <td style='background-color: DeepPink; color: white'>DeepPink</td>
        <td style='background-color: MediumVioletRed; color: white'>MediumVioletRed</td>
    ...
    <tr>
        ...
        <td style='background-color: OrangeRed; color: white'>OrangeRed</td>
    ...
    <tr>
        ...
        <td style='background-color: LightYellow; color: black'>LightYellow</td>
        <td style='background-color: LemonChiffon; color: black'>LemonChiffon</td>
    </tr>
    <tr>
        <td style='background-color: LightGoldenrodYellow; color: black'>LightGoldenrodYellow</td>
        <td style='background-color: PapayaWhip; color: black'>PapayaWhip</td>
        <td style='background-color: Moccasin; color: black'>Moccasin</td>
        <td style='background-color: PeachPuff; color: black'>PeachPuff</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style='background-color: RebeccaPurple; color: white'>RebeccaPurple</td>
        <td style='background-color: BlueViolet; color: white'>BlueViolet</td>
        <td style='background-color: DarkViolet; color: white'>DarkViolet</td>
        <td style='background-color: DarkOrchid; color: white'>DarkOrchid</td>
    </tr>
    <tr>
        <td style='background-color: DarkMagenta; color: white'>DarkMagenta</td>
        <td style='background-color: Purple; color: white'>Purple</td>
        <td style='background-color: Indigo; color: white'>Indigo</td>
        <td style='background-color: SlateBlue; color: white'>SlateBlue</td>
    </tr>
    <tr>
        <td style='background-color: DarkSlateBlue; color: white'>DarkSlateBlue</td>
        <td style='background-color: MediumSlateBlue; color: white'>MediumSlateBlue</td>
    ...
    <tr>
        <td style='background-color: SeaGreen; color: white'>SeaGreen</td>
        <td style='background-color: ForestGreen; color: white'>ForestGreen</td>
        <td style='background-color: Green; color: white'>Green</td>
        <td style='background-color: DarkGreen; color: white'>DarkGreen</td>
    </tr>
    <tr>
        <td style='background-color: YellowGreen'>YellowGreen</td>
        <td style='background-color: OliveDrab'>OliveDrab</td>
        <td style='background-color: Olive; color: white'>Olive</td>
        <td style='background-color: DarkOliveGreen; color: white'>DarkOliveGreen</td>
    </tr>
    <tr>
        <td style='background-color: MediumAquamarine'>MediumAquamarine</td>
        <td style='background-color: DarkSeaGreen'>DarkSeaGreen</td>
        <td style='background-color: LightSeaGreen; color: white'>LightSeaGreen</td>
        <td style='background-color: DarkCyan; color: white'>DarkCyan</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style='background-color: DarkTurquoise; color: white'>DarkTurquoise</td>
        <td style='background-color: CadetBlue; color: white'>CadetBlue</td>
        <td style='background-color: SteelBlue; color: white'>SteelBlue</td>
    ...
    <tr>
        <td style='background-color: DeepSkyBlue; color: white'>DeepSkyBlue</td>
        <td style='background-color: DodgerBlue; color: white'>DodgerBlue</td>
        <td style='background-color: CornflowerBlue'>CornflowerBlue</td>
        <td style='background-color: MediumSlateBlue; color: white'>MediumSlateBlue</td>
    </tr>
    <tr>
        <td style='background-color: RoyalBlue; color: white'>RoyalBlue</td>
        <td style='background-color: Blue; color: white'>Blue</td>
        <td style='background-color: MediumBlue; color: white'>MediumBlue</td>
        <td style='background-color: DarkBlue; color: white'>DarkBlue</td>
    </tr>
    <tr>
        <td style='background-color: Navy; color: white'>Navy</td>
        <td style='background-color: MidnightBlue; color: white'>MidnightBlue</td>
    ...
    <tr>
        ...
        <td style='background-color: Chocolate; color: white'>Chocolate</td>
        <td style='background-color: SaddleBrown; color: white'>SaddleBrown</td>
    </tr>
    <tr>
        <td style='background-color: Sienna; color: white'>Sienna</td>
    ...
    <tr>
        ...
        <td style='background-color: DimGray; color: white'>DimGray</td>
        <td style='background-color: LightSlateGray; color: white'>LightSlateGray</td>
        <td style='background-color: SlateGray; color: white'>SlateGray</td>
    </tr>
    <tr>
        <td style='background-color: DarkSlateGray; color: white'>DarkSlateGray</td>
